...
public class NimaiPostpaidSubscriptionDetails implements Serializable {
	...
	public String toString() {
		return "NimaiPostpaidSubscriptionDetails [postpaidId=" + postpaidId + ", subscriptionDetailsId="
				...
				+ totalDue + ", minDue=" + minDue + ", perTransactionDue=" + perTransactionDue + ", dueType=" + dueType
				+ ", totalPayment=" + totalPayment + ", invoiceId=" + invoiceId + ", paymentTxnId=" + paymentTxnId
				+ ", postpaidStartDate=" + postpaidStartDate + ", makerApprovalBy=" + makerApprovalBy
				+ ", checkerApprovalBy=" + checkerApprovalBy + ", makerApprovalDate=" + makerApprovalDate
				+ ", checkerApprovalDate=" + checkerApprovalDate + ", paymentCounter=" + paymentCounter + ", status="
				+ status + ", remark=" + remark + ", checkerComment=" + checkerComment + ", makerComment="
				+ makerComment + ", paymentmode=" + paymentmode + ", paymentStatus=" + paymentStatus
				+ ", paymentApprovedby=" + paymentApprovedby + ", discountId=" + discountId + ", discountAmount="
				+ discountAmount + "]";
	}
