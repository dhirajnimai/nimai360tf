...
public class OnlinePayment implements Serializable {
	...
	public String toString() {
		return "OnlinePayment [id=" + id + ", userId=" + userId + ", orderId=" + orderId + ", amount=" + amount
				+ ", currency=" + currency + ", bankReceiptNo=" + bankReceiptNo + ", trackingId=" + trackingId
				+ ", statusMessage=" + statusMessage + ", status=" + status + ", failureMessage=" + failureMessage
				+ ", requestDump=" + requestDump + ", responseDump=" + responseDump + ", insertedBy=" + insertedBy
